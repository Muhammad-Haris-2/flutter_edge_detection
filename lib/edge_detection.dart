...
final class NativeDetectionResult extends Struct {
  ...
  factory NativeDetectionResult.allocate(
    ...
    return malloc<NativeDetectionResult>().ref
      ..topLeft = topLeft
      ..topRight = topRight
...
class EdgeDetection {
  static Future<EdgeDetectionResult> detectEdges(String path) async {
    ...
    final detectEdges = nativeEdgeDetection.lookup<NativeFunction<DetectEdgesFunction>>("detect_edges").asFunction<DetectEdgesFunction>();
  ...
  static Future<bool> processImage(
    ...
    final processImage = nativeEdgeDetection.lookup<NativeFunction<process_image_function>>("process_image").asFunction<ProcessImageFunction>();
