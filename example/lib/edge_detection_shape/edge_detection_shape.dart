...
class _EdgeDetectionShapeState extends State<EdgeDetectionShape> {
  ...
  Widget build(BuildContext context) {
    return mg.Magnifier(
      ...
      position: currentDragPosition ?? const Offset(0, 0),
      child: Stack(
        children: [
          _getTouchBubbles(),
          CustomPaint(
  ...
  Offset _clampOffset(Offset givenOffset) {
    ...
    return Offset(absoluteX.clamp(0.0, renderedImageWidth) / renderedImageWidth, absoluteY.clamp(0.0, renderedImageHeight) / renderedImageHeight);
  }
        ...
        children: [
          ...
          Positioned(
            ...
            child: CropBubble(
              ...
              onDrag: (position) {
                setState(() {
                  Offset newBottomRight = _getNewPositionAfterDrag(position, renderedImageWidth, renderedImageHeight);
          ...
          Positioned(
            ...
            child: CropBubble(
              ...
              onDrag: (position) {
                setState(() {
                  Offset newBottomLeft = _getNewPositionAfterDrag(position, renderedImageWidth, renderedImageHeight);
